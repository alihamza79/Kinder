...
import Invoice_Preview from "../Add_Invoices/Invoice_Preview";
import Delete_Invoices from "../Add_Invoices/Delete_Invoices";
import Save_Invoice from "../Add_Invoices/Save_Invoice";
import Bank_Details from "../Add_Invoices/Bank_Details";
import DeleteBank_Details from "./DeleteBank_Details";
                  ...
                  <ul className="breadcrumb invoices-breadcrumb">
                    <li className="breadcrumb-item invoices-breadcrumb-item">
                      <Link to="/invoice-list">
                        <i className="fa fa-chevron-left" /> Back to Invoice
                        List
                      </Link>
                    </li>
                  </ul>
                                  ...
                                  {inputFields.map((data, index) => {
                                    return (
                                      ...
                                      >
                                        ...
                                        <span style={{paddingLeft:"173px"}}>$4</span>
                                        </div>
                                      </div>
                                    );
                                  })}

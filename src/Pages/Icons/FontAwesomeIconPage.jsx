...
// Data
import { FontAwesomeIconData } from "./IconData"

const FontAwesomeIconPage = (props) => {
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Font awesome icon</h1>
            </Col>
      ...
      <section className="bg-lightgray py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] px-[7%] lg:px-[4%] md:px-[15px] xs:px-0">
        <Container fluid>
          <Row xl={4} lg={3} sm={2} xs={1} className="gap-y-10 justify-center">
            {
              FontAwesomeIconData.map((item, i) => {
                return (
                  <Col key={i}>
...
export default FontAwesomeIconPage
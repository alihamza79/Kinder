...
const IconsMindSolidPage = (props) => {
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Icons mind solid icon</h1>
            </Col>
...
export default IconsMindSolidPage
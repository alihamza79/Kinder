...
const HeaderResponsiveSticky = (props) => {
        ...
        <div style={props.style}>
            ...
            <div className="full-screen relative overflow-hidden md:h-[650px] sm:h-[400px]">
                ...
                <div className="scroll-down-bottom absolute bottom-[30px] w-auto left-0 right-0 z-[1]">
                    <ScrollTo to="about" offset={0} delay={0} spy={true} smooth={true} duration={800} className="section-link block w-[2px] h-[35px] bg-white mx-auto right-0 left-0 absolute hover:text-white cursor-pointer">
            ...
            {/* Section Start */}
            <section id="about" className="py-[160px] bg-black overflow-hidden lg:py-[120px] md:py-[90px] sm:py-[80px] xs:py-[50px]">
                <Container>
                    <Row>
                        <Col xl={4} lg={5} md={6}>
...
export default HeaderResponsiveSticky

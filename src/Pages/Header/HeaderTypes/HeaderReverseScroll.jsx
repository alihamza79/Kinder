...
const HeaderReverseScroll = (props) => {
    return (
            ...
            <Header topSpace={{ md: true }} type="reverse-scroll">
                <HeaderNav fluid="fluid" theme="dark" expand="lg" className="py-[0px] px-[35px] md:px-[15px] md:py-[20px] sm:px-0">
                    ...
                    <Col lg={2} xs={"auto"} className="justify-end pe-0 flex items-center">
                        <SocialIcons className="justify-end" theme="social-icon-style-01" size="xs" data={SocialIconData} />
                    </Col>
                </HeaderNav>
            </Header>
            {/* Header End */}
...
export default HeaderReverseScroll;

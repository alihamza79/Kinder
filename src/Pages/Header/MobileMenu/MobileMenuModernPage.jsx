...
const MobileMenuModernPage = (props) => {
  return (
    <div style={props.style}>
      {/* Header Start */}
      <Header topSpace={{ md: true }} type="reverse-scroll">
        <HeaderNav theme="dark" expand="lg" containerClass="sm:px-0" className="py-[0px] md:py-[18px]">
          ...
          <Menu className="col-lg-8 md:hidden" {...props} />
          <MobileMenu className="order-last d-lg-none" type="modern" {...props} />
          <Col className="col-auto col-lg-2 text-end pe-0 md:mr-[10px]">
          ...
          <Row className="justify-center lg:justify-start md:justify-center sm:justify-start items-center h-[100vh] md:flex-row  md:h-[600px] md:flex">
            <Col xl={5} lg={6} md={7} sm={10}>
              <h2 className="font-serif font-medium leading-[65px] tracking-[-1px] text-white opacity-[1] mb-[65px] md:leading-[65px] xs:leading-[50px] md:mb-[25px]">We provide
                <span className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] font-semibold inline-block">reliable business</span>consulting help
              </h2>
                ...
                modalBtn={
                  <span className="cursor-pointer">
                    <span className="w-[120px] h-[120px] text-[34px] flex justify-center items-center rounded-[50%] border-white border-[3px] sm:w-[80px] sm:h-[80px] sm:text-[28px]">
                      <i className="icon-control-play ml-[5px] text-white"></i>
                    </span>
                  </span>
                } >
...
export default MobileMenuModernPage;
      ...
      <section className="bg-darkgray py-[25px] page-title-small p-[130px] xxs:px-0">
        <Container>
          <Row className="items-center justify-center">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-lg text-white font-medium mb-0 md:text-center">YouTube video modal</h1>
            </Col>
        ...
        <Container>
          <Row className="justify-center">
            <Col md={12} className="text-center">
              <h6 className="font-medium text-darkgray font-serif mb-[25px] lg:mb-[15px]">Popup with YouTube video</h6>
            </Col>
            <Col xl={5} lg={8} md={10} className="text-center">
              <h6 className="mb-[8%] font-light lg:mb-[60px] md:mb-[45px] sm:mb-[30px]">In this example lightboxes are automatically disabled on small screen size and default behavior of link is triggered.</h6>
               ...
               <CustomModal.Wrapper
                modalBtn={<Buttons type="submit" className="btn-fill mx-3 font-medium font-serif rounded-[4px] uppercase" themeColor="#0038e3" color="#fff" size="md" title="Open Youtube Video" />} >

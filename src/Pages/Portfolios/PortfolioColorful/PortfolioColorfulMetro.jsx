        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px]">
            <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio colorful metro column</h1>
          ...
          <Row>
            <Col xs={12} className="xs:px-0">
              <PortfolioColorful
                ...
                data={portfolioColorfulMetroData}
              />
            </Col>
          </Row>
        </Container>

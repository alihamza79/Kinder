...
// Data
import { FilterData, portfolioColorfulData } from '../../../Components/Portfolio/PortfolioData'

const PortfolioColorfulFourColPage = (props) => {
  return (
    <div style={props.style}>
        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px]">
            <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio colorful four column</h1>
      ...
      <section className="pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px] relative px-[100px] pt-0 lg:px-2 xs:px-0">
        <Container fluid>
          <Row>
            <Col xs={12} className="xs:px-0">
              <PortfolioColorful
                ...
                carouselOption={{ slidesPerView: 4, spaceBetween: 30, loop: true, navigation: false, autoplay: { delay: 3000, disableOnInteraction: false }, pagination: { dynamicBullets: true, clickable: true }, breakpoints: { 1200: { slidesPerView: 4 }, 992: { slidesPerView: 3 }, 768: { slidesPerView: 2 } } }}
              />
            </Col>
          </Row>
        </Container>
...
export default PortfolioColorfulFourColPage
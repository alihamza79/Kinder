...
// Data
import { FilterData, portfolioOverlayMesonryData } from '../../../Components/Portfolio/PortfolioData'

const PortfolioOverlayMasonryPage = (props) => {
  return (
    <div style={props.style}>
        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px]">
            <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio overlay masonry column</h1>
      ...
      <section className="relative pt-0 pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px]">
        <Container fluid>
          <Row>
            <Col xs={12} className="xs:px-0">
              <PortfolioOverlay
                ...
                data={portfolioOverlayMesonryData}
              />
            </Col>
          </Row>
        </Container>
...
export default PortfolioOverlayMasonryPage
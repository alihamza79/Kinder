...
const PortfolioOverlayFourColPage = (props) => {
  return (
    <div style={props.style}>
        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px]">
            <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio overlay four column</h1>
      ...
      <section className="relative px-[73px] overflow-hidden pt-0 py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] xs:py-[50px] xs:px-0">
        <Container fluid>
          <Row>
...
export default PortfolioOverlayFourColPage
...
// Data
import { FilterData, portfolioClassicData } from '../../../Components/Portfolio/PortfolioData'

const PortfolioClassicFourColPage = (props) => {
  return (
    <div style={props.style}>
        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px]">
            <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio classic four column</h1>
      ...
      <section className="pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px] relative bg-lightgray px-[4%] lg:px-[2%] sm:px-0">
        <Container fluid>
          <Row>
...
export default PortfolioClassicFourColPage
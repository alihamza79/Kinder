...
// Data
import { FilterData, portfolioBorderedData } from '../../../Components/Portfolio/PortfolioData'

const PortfolioBorderedThreeColPage = (props) => {
    return (
        <div style={props.style}>
                ...
                <Container className="h-full relative">
                    <Row className="justify-center h-[300px] sm:h-[250px]">
                        <Col xl={6} lg={6} sm={8} className="text-center flex justify-center flex-col font-serif">
                            <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block text-xmd leading-[20px]">Portfolio bordered three column</h1>
            ...
            <section className="py-[130px] pt-0 overflow-hidden relative lg:py-[90px] md:py-[75px] sm:py-[50px]">
                <Container>
                    <Row>
                        <Col xs={12} className="xs:px-0">
                            <PortfolioBordered
                                overlay={["#556fff", "#b263e4", "#e05fc4", "#f767a6", "#ff798e"]}
                                grid="grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large"
...
export default PortfolioBorderedThreeColPage

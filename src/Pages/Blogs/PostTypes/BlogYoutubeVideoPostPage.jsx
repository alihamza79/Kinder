...
const BlogYoutubeVideoPostPage = (props) => {
                ...
                <Col lg={8} className="right-sidebar md:mb-[60px] sm:mb-[40px]">
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      ...
                      <div className="fit-video mb-[4.5rem]">
                        <iframe title="myFrame" width="560" height="315" src="https://www.youtube.com/embed/sU3FkzUKHXU?autoplay=1;&mute=1;rel=0&amp;showinfo=0" allowfullscreen></iframe>
                      </div>
...
export default BlogYoutubeVideoPostPage
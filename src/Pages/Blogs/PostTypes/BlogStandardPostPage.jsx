                  ...
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      <ul className="flex mb-8 xs:block">
                        {
                          data[0].date && <li className="inline-block align-middle mr-[25px]">
                            <i className="feather-calendar text-fastblue mr-[10px]"></i>
                            <span>{data[0].date}</span>
                          </li>
                        }
                        <li className="inline-block align-middle mr-[25px]"><i className="feather-folder text-fastblue mr-[10px]"></i>
                          {
                      ...
                      <img width="" height="" src={data[0].img} alt="" className="w-full rounded-[6px] mb-[4.5rem]"></img>

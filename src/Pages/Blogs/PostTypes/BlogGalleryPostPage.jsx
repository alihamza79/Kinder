...
const BlogGalleryPostPage = (props) => {
                ...
                <Col lg={8} className="right-sidebar md:mb-[60px] sm:mb-[40px]">
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      ...
                      <ImageGallery theme="image-gallery-01 grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-small mb-[4.5rem]" data={imageGalleryData01} overlay="#232323" animation={fadeIn} />
...
export default BlogGalleryPostPage
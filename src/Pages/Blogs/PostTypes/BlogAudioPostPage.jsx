                  ...
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      ...
                      <div className="mb-[4.5rem]">
                        <iframe title="myframe" className="h-[400px] w-full" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/3005344&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
                      </div>
                    ...
                    <SocialIcons theme="social-icon-style-09" className="justify-center m-auto" size="md" iconColor="dark" data={SocialIconsData} animation={fadeIn} />
                  </Row>
                </Col>
...
export default BlogAudioPostPage
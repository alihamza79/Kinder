...
const BlogHtml5VideoPostPage = (props) => {
                  ...
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      ...
                      <div className="mb-[4.5rem]">
                        <video className="rounded-[6px]" autoPlay muted loop controls><source src="/assets/video/video.mp4" type="video/mp4" /></video>
                      </div>
...
export default BlogHtml5VideoPostPage
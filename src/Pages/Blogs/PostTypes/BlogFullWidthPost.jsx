                ...
                <div className="md:mb-[60px] sm:mb-[40px] xs:mb-0">
                  <Row>
                    <Col className="blog-details-text last:mb-0 mb-24">
                      ...
                      <img src="https://via.placeholder.com/780x500" height="" width="" alt="" className="w-full rounded-[6px] mb-[4.5rem]" />
                      ...
                      <Blockquote
                        ...
                        author="JOHN WAYNE" />
                      <img src="https://via.placeholder.com/780x500" height="" width="" alt="" className="w-full rounded-[6px] mb-16" />
                    ...
                    <Col>
                      <AuthorBox authorId={data[0].author} className="mb-[50px]" />
                    </Col>

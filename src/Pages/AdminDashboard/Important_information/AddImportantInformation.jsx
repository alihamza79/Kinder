...
const AddImportantInformation = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await addDocument('importantInformation', {
                title: title,
                description: description,
            });

            sessionStorage.setItem('addImportantInformationSuccess', 'true');
                    ...
                    <div className="page-header">
                        ...
                        <div className="col-sm-12">
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Add Important Information</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                <div className="form-heading">
                                                    <h4>Add Important Information</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-12">
                                                <div className="doctor-submit text-end">
                                                    ...
                                                    <Link to="/importantinformationbody">
                                                        <button
                                                            type="button"

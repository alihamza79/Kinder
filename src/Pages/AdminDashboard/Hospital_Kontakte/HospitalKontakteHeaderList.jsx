...
const HospitalKontakteHeaderList = () => {
  const [dataSource, setDataSource] = useState([]);
  const [loading, setLoading] = useState(false);
  const location = useLocation();

  useEffect(() => {
    const updateSuccess = sessionStorage.getItem("updateHospitalKontakteHeaderSuccess");
          ...
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              <Link
                ...
                to={`/hospitalkontakteheader/edithospitalkontakteheader/${record.id}`}
              >
                      ...
                      <div className="row align-items-center">
                        <div className="col">
                          <div className="doctor-table-blk">
                            <h3>Hospital Kontakte Headers</h3>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default HospitalKontakteHeaderList;

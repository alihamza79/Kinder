...
const RightSidebar = (props) => {
  return (
    <div style={props.style}>
        ...
        <Container className="h-full relative">
          <Row className="justify-center h-[300px] sm:h-[250px] m-0 items-stretch w-full">
            <Col xl={6} lg={7} md={9} className="text-center flex justify-center flex-col font-serif xs:px-0">
              <h1 className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] mb-[15px] inline-block leading-[20px] text-xmd">Shop right sidebar</h1>
      ...
      {/* Section Start */}
      <section className="shopping-right-left-sidebar pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px]">
        <Container>
          <Row>
            <Col lg={9} md={8} className="pr-[55px] md:pr-[15px] sm:mb-[30px] order-1 xs:px-0">
              <ShopWide filter={false} grid="product-listing shop-wrapper grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large text-center" data={shopWideData} />
            </Col>

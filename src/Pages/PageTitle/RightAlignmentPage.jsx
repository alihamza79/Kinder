      ...
      <section className="bg-lightgray py-[40px] sm:py-[30px]">
        <Container>
          <Row className="xs:text-center">
            <Col xl={4} lg={6} className="breadcrumb justify-start px-[15px] md:mb-[15px]  text-sm font-serif md:justify-center">
              <ul>
                <li><Link aria-label="link for" to="/">Home</Link></li>
                <li><Link aria-label="link for" to="#">Pages</Link></li>
                <li>Title right alignment</li>
              </ul>
            </Col>
            <Col xl={8} lg={6} className="flex justify-end md:justify-center sm:block sm:text-center">
              <h1 className="text-lg text-darkgray font-medium mb-0 font-serif inline-block">Right alignment</h1>
...
export default RightAlignmentPage

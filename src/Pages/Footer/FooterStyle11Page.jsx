...
// Components
import FooterStyle11 from "../../Components/Footers/FooterStyle11";
...
const FooterStyle11Page = (props) => {
  return (
    <div style={props.style}>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Footer style 11</h1>
            </Col>
      ...
      {/* Section End */}
      <FooterStyle11 className="py-[10.5rem] md:py-[8.5rem] bg-darkslateblue" theme="dark" />
    </div>
  )
};

export default FooterStyle11Page;

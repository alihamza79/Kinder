...
const FooterStyle07Page = (props) => {
  return (
    <div style={props.style}>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Footer style 07</h1>
            </Col>
      ...
      {/* Section End */}
      <FooterStyle07 className="bg-[#262b35] text-slateblue" logo="/assets/img/webp/logo-gradient-sky-blue-pink-white.webp" theme="dark" />
    </div>
  )
};

export default FooterStyle07Page;

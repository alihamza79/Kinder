...
const FooterStyle08Page = (props) => {
  return (
    <div style={props.style}>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Footer style 08</h1>
            </Col>
      ...
      {/* Section End */}
      <FooterStyle08 className="bg-[#262b35] text-slateblue" theme="dark" />
    </div>
  )
};

export default FooterStyle08Page;

  ...
  return (
    <div style={props.style}>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Footer style 05</h1>
            </Col>
     ...
     <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] bg-white">
      ...
      {/* Section End */}
      <FooterStyle05 className="bg-[#262b35] text-slateblue" logo="/assets/img/webp/logo-white.webp" theme="dark" />
    </div>
  )
};

export default FooterStyle05Page;

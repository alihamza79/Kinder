...
const FooterStyle04Page = (props) => {
  return (
    <div style={props.style}>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Footer style 04</h1>
            </Col>
      ...
      {/* Section End */}
      <FooterStyle04 theme="light" />
    </div>
  )
};

export default FooterStyle04Page;
